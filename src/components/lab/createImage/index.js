  ...
  return (
    <>
      <form key={1} onSubmit={handleSubmitCreate(handleCreateForm)}>
        <p className="mb-4 text-primary text-xl p-3 rounded">
          Limit: ＜ 1000 chars{" "}
        </p>
        ...
        <textarea
          placeholder="Less than 1000 chars"
        ...
        <p className="mb-2">
          {errorsCreate.createDescription && (
            <span className="text-red-600">This field is required</span>
          )}
        </p>
        <input
          className="mt-2 mb-5 cursor-pointer btn btn-secondary"
          type="submit"
        />
      </form>
    </>
